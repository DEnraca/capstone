    ...
    <div class="grid grid-cols-4 gap-1">
        ...
        >
            ...
            <div class="grid grid-rows-[10%_1fr] h-full border rounded py-2 px-4">
                <div v-if="getColumns(queue.next_in_line).length" class="flex gap-2 mt-2 text-gray-600">
                    <!-- Loop each column -->
                    <div
                ...
                <div v-else class="rounded text-center text-md font-bold text-gray-400 mt-4">
