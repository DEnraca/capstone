        ...
        <div class="col-span-1">
            <ul class="divide-y divide-gray-200 grid grid-rows-[8%_1fr] gap-2">
                <div class="flex items-center justify-center m0">
                    <h4 class="text-bold  text-center ">Selected Service: <span
                ...
                <div>
                        ...
                        @if (!empty($this->selectedService))
                            @foreach ($this->selectedService as $service)
                                ...
                                <div class="flex items-center space-x-4 py-2 rtl:space-x-reverse cursor-pointer"
                                    ...
                                    <div
                                        class="inline-flex items-center text-base font-semibold text-gray-900 justify-center">
                    ...
                    <div class="flex justify-end m-2 <?php if (count($this->selectedService) <= 0) {
                        ...
                        <x-filament::button color="primary" wire:click="submitServiceSelection"
                            class="text-xs">Proceed</x-filament:button>
                    </div>
