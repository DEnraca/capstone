            ...
            <section class="relative min-h-[400px] md:min-h-[450px] lg:min-h-[660px] bg-white">
                ...
                <header
                    ...
                    <div class="flex items-center">
                        ...
                        <h3 id="header-title" class="text-xs sm:text-lg font-bold tracking-wide uppercase ml-2">
                            ABR Diagnostics Center
                        </h3>
                    </div>
                ...
                <!-- Mobile Menu -->
                <nav id="mobile-menu"
                    class="fixed top-[62px] left-0 w-full bg-white/10 backdrop-blur-xl border-b border-white/20 text-white hidden flex-col px-6 py-8 z-40 md:hidden shadow-lg space-y-4 text-center text-sm uppercase">
                    <a href="#hero"
