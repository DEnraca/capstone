...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"   style="height:32px;width:167px;v-text-anchor:middle;" arcsize="13%" fillcolor="#ffdca1">
<v:stroke dashstyle="Solid" weight="0px" color="#ffdca1"/>
<w:anchorlock/>
<v:textbox inset="0px,0px,0px,0px">
<center dir="false" style="color:#d08500;font-family:sans-serif;font-size:11px">
<![endif]--><span class="button" style="background-color: #ffdca1; mso-shading: transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; border-radius: 4px; border-right: 0px solid transparent; border-top: 0px solid transparent; color: #d08500; display: inline-block; font-family: Arial, Helvetica, sans-serif; font-size: 11px; font-weight: 400; mso-border-alt: none; padding-bottom: 5px; padding-top: 5px; padding-left: 20px; padding-right: 20px; text-align: center; width: auto; word-break: keep-all; letter-spacing: normal;"><span
                                                                            style="word-break: break-word; line-height: 22px;">Appointment
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">
                                                                        <strong>Dear {{ $data['name'] }}
                                                                            ,</strong><br><br>Thank you for scheduling
                                                                        your appointment with ABR Diagnostic Center. We
                                                                        have successfully confirmed your booking and
                                                                        look forward to providing you with exceptional
                                                                        diagnostic service
                                                                    </p>
                                                                </div>
                                                            </td>
