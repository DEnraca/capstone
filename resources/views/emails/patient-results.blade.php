                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Good Day Mr/Ms.:
                                                                        {{ $transaction->patient->getFullname() }} !
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:17px;">
                                                                    <p style="margin: 0;">
                                                                        Thank you for choosing ABR Diagnostic Center. Your laboratory test results are attached to this email. Please review the attached files for your records.
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
