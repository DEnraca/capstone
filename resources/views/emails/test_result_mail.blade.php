                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; border-radius: 0; color: #000000; width: 590px; margin: 0 auto;"
                                        width="590">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div class="alignment" align="center">
                                                                    <div style="max-width: 590px;"><img
                                                                            src="https://4fd27af511.imgdist.com/pub/bfra/g9j5av8y/gml/s12/3on/logo.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            width="590" alt title height="auto">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td class="column column-1" width="100%"
                                                    ...
                                                    <table class="paragraph_block block-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:13px;font-weight:400;letter-spacing:0px;line-height:1.2;text-align:left;mso-line-height-alt:16px;">
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">We hope
                                                                        this message finds you well. We would like to
                                                                        inform you that your diagnostic test results are
                                                                        now available for your review. Our medical team
                                                                        has carefully processed and verified your test
                                                                        data to ensure accuracy and reliability.</p>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; width: 590px; margin: 0 auto;"
                                        width="590">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                                ...
                                                                <table class="icons-inner"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="https://designedwithbeefree.com/"
                                                                                target="_blank"
